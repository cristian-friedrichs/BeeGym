    ...
    async create(data: Partial<Assinatura>): Promise<Assinatura> {
        const { data: sub, error } = await supabaseAdmin
            ...
            .insert({
                ...
                proximo_vencimento: data.proximoVencimento ? data.proximoVencimento.toISOString() : null,
                inicio_carencia: data.inicioCarencia ? data.inicioCarencia.toISOString() : null,
