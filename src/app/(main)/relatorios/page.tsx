    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div>
                ...
                <p className="text-muted-foreground mt-1">Selecione os filtros e clique em <strong>Gerar Relatório</strong> para visualizar e exportar.</p>
            </div>
                                        ...
                                        <TableHeader>
                                            <TableRow className="bg-slate-50/50 hover:bg-slate-50/50">
                                                {Object.keys(data[0]).map(key => (
                                                    <TableHead key={key} className="h-12 font-bold text-slate-700 text-[11px] uppercase tracking-wider">
                                                        {key}
                                                    </TableHead>
                                                ))}
                                            </TableRow>
