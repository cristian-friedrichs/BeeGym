    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-deep-midnight font-display">Alunos</h1>
                    <p className="text-muted-foreground font-sans">Gerenciamento de alunos e matrículas</p>
                </div>
                <Button
            ...
            <div className="bg-white p-4 rounded-[8px] border border-slate-100 shadow-sm flex flex-col md:flex-row gap-4 justify-between items-center bg-white">
            ...
            <div className="bg-white rounded-[8px] border border-slate-100 shadow-sm overflow-hidden bg-white">
                <Table>
                    <TableHeader>
                        <TableRow className="bg-slate-50/50 hover:bg-slate-50/50">
                            <TableHead className="w-[300px] font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Aluno</TableHead>
                            <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Objetivo</TableHead>
                            <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Plano</TableHead>
                            <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Última Atividade</TableHead>
                                    ...
                                    <TableCell>
                                        <Link href={`/alunos/${student.id}`} className="flex items-center gap-3">
                                            <Avatar className="h-10 w-10 border border-slate-100 ring-1 ring-slate-100 ring-offset-2">
                                                ...
                                                <AvatarFallback className="bg-orange-100 text-bee-orange font-bold">
                                                    {student.full_name.substring(0, 2).toUpperCase()}
                                                </AvatarFallback>
                                            </Avatar>
                                            <div className="flex flex-col">
                                                <span className="font-bold text-slate-900 group-hover:text-bee-orange transition-colors font-sans">
                                                    {student.full_name}
                                                </span>
