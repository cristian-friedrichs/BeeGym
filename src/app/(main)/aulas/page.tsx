  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-deep-midnight font-display">Aulas Agendadas</h1>
          <p className="text-muted-foreground font-sans">Próximas aulas coletivas do calendário</p>
        </div>
        <Button
      ...
      <div className="bg-white p-4 rounded-[8px] border border-slate-100 shadow-sm flex flex-col xl:flex-row gap-4 justify-between items-center">
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50/50 hover:bg-slate-50/50">
              <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Aula</TableHead>
              <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Data/Hora</TableHead>
              <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Instrutor</TableHead>
              <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Local</TableHead>
              <TableHead className="font-bold text-deep-midnight font-display uppercase text-[11px] tracking-widest">Capacidade</TableHead>
                  ...
                  >
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className="font-bold text-slate-900 group-hover:text-bee-orange transition-colors font-sans">{cls.title}</span>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2 text-sm text-slate-700 font-medium">
                        <CalendarIcon className="w-4 h-4 text-bee-orange" />
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-2">
                        <Button variant="ghost" size="icon" className="h-8 w-8 text-slate-400 hover:text-bee-orange" disabled onClick={(e) => e.stopPropagation()}>
