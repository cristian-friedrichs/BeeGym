...
export default function AgentApprovalsPage() {
    return (
        <div className="space-y-8 pb-12">
            <SectionHeader title="Aprovacoes Pendentes" subtitle="Fila visual de acoes que exigem decisao do CEO antes de qualquer execucao real" />
            <MockDataNotice />
            ...
            <div className="rounded-2xl border border-red-100 bg-red-50/70 px-4 py-3 text-xs font-bold text-red-700 shadow-sm">
                Botoes Aprovar mock e Rejeitar mock sao apenas visuais. Eles nao chamam API, nao alteram banco e nao disparam GitHub.
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 rounded-[2rem] border border-white/60 bg-white/40 p-2 shadow-sm backdrop-blur-sm">
                <div className="relative min-w-[260px] flex-1">
                    ...
                    <Input placeholder="Buscar aprovacao, risco, agente ou impacto..." className="h-11 rounded-2xl border-slate-100 bg-white pl-10 text-sm font-medium shadow-sm" />
                </div>
                <Select defaultValue="all">
                    ...
                    <SelectContent className="rounded-2xl border-slate-100 shadow-xl">
                        ...
                        <SelectItem value="reviewing" className="rounded-xl font-bold">Em revisao</SelectItem>
                    </SelectContent>
                </Select>
                <Select defaultValue="all">
                    <SelectTrigger className="h-11 w-44 rounded-2xl border-slate-100 bg-white font-bold text-slate-600 shadow-sm">
                    ...
                    <SelectContent className="rounded-2xl border-slate-100 shadow-xl">
                        ...
                        <SelectItem value="critical" className="rounded-xl font-bold text-red-700">Critica</SelectItem>
                        <SelectItem value="high" className="rounded-xl font-bold text-orange-700">Alta</SelectItem>
                        <SelectItem value="medium" className="rounded-xl font-bold text-amber-700">Media</SelectItem>
                    </SelectContent>
                </Select>
            </div>
