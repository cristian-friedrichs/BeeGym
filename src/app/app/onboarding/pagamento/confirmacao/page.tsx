                ...
                <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-green-50/20 p-4 md:p-8 items-center">
                    <div className="max-w-6xl mx-auto w-full space-y-6">
                        ...
                        <div className="text-center space-y-6">
                            ...
                            <div>
                                <h1 className="text-2xl font-black font-display text-[#0B0F1A]">Aguardando confirmação</h1>
                            ...
                            <Button
                                className="w-full h-12 text-base font-bold bg-bee-amber hover:bg-amber-500 text-bee-midnight rounded-2xl shadow-orange-200 shadow-md"
                                asChild
                            >
                                <Link href="/painel">
            ...
            <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/20 p-4 md:p-8 items-center">
                <div className="max-w-6xl mx-auto w-full space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <h1 className="text-2xl font-black font-display text-[#0B0F1A]">Autorize no seu banco</h1>
                        <p className="text-slate-500 mt-2 text-sm leading-relaxed">
                    ...
                    {pixCopiaECola && (
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col items-center space-y-4">
                            ...
                            <div className="w-full space-y-2">
                                <Button
                                    variant="outline"
                                    className="w-full h-12 border-2 border-slate-100 hover:bg-slate-50 text-[#0B0F1A] font-bold rounded-2xl flex items-center justify-center gap-2"
            ...
            <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-amber-50/20 p-4 md:p-8 items-center">
                <div className="max-w-6xl mx-auto w-full space-y-6">
                    ...
                    <div className="text-center space-y-6">
                        ...
                        <div>
                            <h1 className="text-2xl font-black font-display text-[#0B0F1A]">Pagamento em análise</h1>
                    ...
                    <div className="text-center space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 text-left space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-bold text-[#0B0F1A]">{proximaCobranca}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-slate-400">Valor</span>
                                <span className="font-bold text-bee-amber">{precoFormatado}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-slate-400">Plano</span>
                                <span className="font-bold text-[#0B0F1A]">{plano}</span>
                            </div>
                        </div>
