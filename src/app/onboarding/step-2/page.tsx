...
export default function OnboardingStep2() {
    ...
    return (
        <div className="flex h-screen bg-gradient-to-br from-slate-50 to-orange-50/20 p-2 md:p-4 overflow-hidden">
                ...
                <Card className="border-slate-200 shadow-xl shadow-slate-200/50 bg-white/70 backdrop-blur-md overflow-hidden rounded-3xl">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div className="p-6 space-y-4">
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-sm font-bold uppercase tracking-wider text-[#00173F]">Identificação do Espaço</h3>
                                    </div>
                            ...
                            <div className="p-6 bg-slate-50/50 border-l border-slate-100 space-y-4">
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        <div className="w-1 h-4 bg-orange-500 rounded-full" />
                                        <h3 className="text-sm font-bold uppercase tracking-wider text-[#00173F]">Localização</h3>
                                    </div>
                    ...
                    <CardFooter className="flex justify-between border-t p-6 bg-white">
                        <Button
                            ...
                            className="rounded-2xl text-slate-400 hover:text-slate-600 hover:bg-slate-50 px-8 h-12 font-bold uppercase tracking-widest text-[10px]"
                        >
                            Voltar
                        </Button>
                        <Button
                            ...
                            className="h-12 px-10 bg-bee-orange hover:bg-orange-500 text-white font-black rounded-2xl shadow-xl shadow-orange-100 hover:scale-[1.02] active:scale-[0.98] transition-all"
                        >
