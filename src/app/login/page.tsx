      ...
      >
        ...
        <div
          ...
          style={{
            ...
            position: 'relative',
            overflow: 'hidden',
            background: 'linear-gradient(160deg, #00173F 0%, #020d28 60%, #030712 100%)',
          }}
          aria-hidden="true"
          id="login-left-panel"
        >
          ...
          <div style={{
            ...
            <div style={{ marginTop: 'auto', paddingBottom: '64px' }}>
              <div style={{
                ...
                <span style={{ color: '#ff8c00', fontSize: '12px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              ...
              <h1 style={{
                ...
                Sua academia no<br />
                <span style={{ color: '#ff8c00' }}>próximo nível.</span>
              </h1>
        ...
        <div style={{
          ...
          >
            ...
            <div className="form-field field-1" style={{ marginBottom: '32px', textAlign: 'center' }} id="login-mobile-logo">
              {imgError ? (
                <div style={{ color: '#00173F', fontSize: '24px', fontWeight: 900, letterSpacing: '-0.05em', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                  <svg viewBox="0 0 24 24" width="28" height="28" fill="#ff8c00">
                    <path d="M12 2L2 7l10 5 10-5-10-5zm0 14.5l-10-5v5.1l10 5 10-5v-5.1l-10 5z" />
                  </svg>
                  BeeGym
                </div>
              ) : (
                <Image
                  src="/logo-dark.png" // Presumindo que exista um logo escuro
                  alt="BeeGym"
                  width={140}
                  height={46}
              ...
              >
                {googleLoading ? (
                  <svg className="spinner" width="18" height="18" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M12 2a10 10 0 0 1 10 10" stroke="#ff8c00" strokeWidth="3" strokeLinecap="round" />
                  </svg>
                ) : (
              ...
              <div className="form-field field-5" id="login-submit-section">
                <button
                  ...
                  style={{
                    width: '100%',
                    height: '50px',
                    background: loading ? 'rgba(255,140,0,0.5)' : '#ff8c00',
                    border: 'none',
                    borderRadius: '6px',
                    color: '#fff',
                    fontSize: '15px',
                    ...
                    gap: '10px',
                    letterSpacing: '0.01em',
                    boxShadow: loading ? 'none' : '0 4px 14px rgba(255,140,0,0.25)',
                  }}
                  aria-busy={loading}
                >
                  {loading ? (
  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, transparent 40%, rgba(255,140,0,0.03) 60%, transparent 70%)',
        pointerEvents: 'none',
      }} />
    </>
  )
