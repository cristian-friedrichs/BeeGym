            ...
            <Table>
                <TableHeader>
                    <TableRow className="border-slate-50 bg-slate-50/50 hover:bg-slate-50/50">
                        <TableHead className="h-12 px-6 text-[10px] font-black uppercase tracking-widest text-slate-400">Acao solicitada</TableHead>
                        ...
                        <TableHead className="h-12 text-right text-[10px] font-black uppercase tracking-widest text-slate-400">Acoes mock</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    ...
                    {approvals.length === 0 && (
                        <TableRow>
                            <TableCell colSpan={7} className="h-32 text-center text-sm font-medium text-slate-400">
                                Nenhuma aprovacao mockada encontrada.
                            </TableCell>
                        </TableRow>
                    )}
                </TableBody>
