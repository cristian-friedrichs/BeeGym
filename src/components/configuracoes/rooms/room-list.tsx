    ...
    return (
        <div className="flex-1 space-y-6">
            ...
            <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                <DialogContent className="max-w-[520px] p-0 gap-0 rounded-2xl overflow-hidden">
                    <DialogHeader className="px-6 pt-5 pb-4 border-b border-slate-100">
                        <DialogTitle className="text-[17px] font-semibold text-slate-900 leading-tight">Nova Sala</DialogTitle>
                        <p className="text-sm text-slate-500 mt-0.5">{currentUnit ? `Unidade: ${currentUnit.name}` : 'Defina o espaço para aulas e treinos.'}</p>
                    </DialogHeader>
                    ...
                    <div className="px-6 pb-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <Button type="submit" form="add-room-form" disabled={isLoading || units.length === 0} className="h-9 rounded-full px-6 bg-bee-amber hover:bg-amber-500 text-bee-midnight font-semibold text-sm shadow-sm">
            ...
            <Dialog open={!!editingRoom} onOpenChange={(open) => !open && setEditingRoom(null)}>
                <DialogContent className="max-w-[520px] p-0 gap-0 rounded-2xl overflow-hidden">
                    <DialogHeader className="px-6 pt-5 pb-4 border-b border-slate-100">
                        <DialogTitle className="text-[17px] font-semibold text-slate-900 leading-tight">{editingRoom?.name || 'Editar Sala'}</DialogTitle>
                        <p className="text-sm text-slate-500 mt-0.5">Atualize as informações deste espaço.</p>
                    </DialogHeader>
                    <div className="px-6 py-5 max-h-[65vh] overflow-y-auto">
                    ...
                    <div className="px-6 pb-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <Button type="submit" form="edit-room-form" disabled={isLoading} className="h-9 rounded-full px-6 bg-bee-amber hover:bg-amber-500 text-bee-midnight font-semibold text-sm shadow-sm">
            ...
            <Dialog open={!!deletingRoomId} onOpenChange={(open) => !open && setDeletingRoomId(null)}>
                <DialogContent className="max-w-[400px] p-0 gap-0 rounded-2xl overflow-hidden">
                    <DialogHeader className="px-6 pt-5 pb-4 border-b border-slate-100">
                        <DialogTitle className="text-[17px] font-semibold text-slate-900 leading-tight">Excluir sala</DialogTitle>
                    ...
                    <div className="px-6 pb-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <Button onClick={handleDeleteRoom} disabled={isLoading} className="h-9 rounded-full px-6 bg-red-600 hover:bg-red-700 text-white font-semibold text-sm shadow-sm">
