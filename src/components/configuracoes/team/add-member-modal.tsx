...
interface AddMemberModalProps { organizationId: string; }
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <Button className="gap-2 bg-bee-amber hover:bg-amber-500 text-bee-midnight font-semibold rounded-full text-sm shadow-sm">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <SheetFooter className="px-6 pb-5 pt-4 border-t border-slate-100 flex-none gap-2 flex-row">
                            ...
                            <Button type="submit" disabled={isSubmitting || noRolesAvailable}
                                className="flex-1 h-9 rounded-full bg-bee-amber hover:bg-amber-500 text-bee-midnight font-semibold text-sm shadow-sm disabled:opacity-50">
                                {isSubmitting
