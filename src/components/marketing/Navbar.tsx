        ...
        <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md border-b border-slate-200/50 shadow-soft py-3' : 'bg-transparent py-5'}`}>
            <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8 font-medium text-sm text-slate-700">
                    ...
                    <Link href="#para-quem" className="hover:text-bee-midnight transition-colors">Para quem é</Link>
                ...
                <div className="flex items-center gap-4">
                    <Link href="/login" className="hidden md:block text-sm font-semibold text-bee-midnight hover:text-bee-orange transition-colors">
                        Login
                    </Link>
                    <Link href="/register">
                        <Button className="bg-bee-amber hover:bg-bee-orange text-bee-midnight font-bold rounded-full px-6 shadow-sm hover:shadow-md transition-all">
                            Crie uma Conta
                        </Button>
                    </Link>
                </div>
