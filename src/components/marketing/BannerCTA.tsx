            ...
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    <Link href="/register" className="w-full sm:w-auto">
                        <Button size="lg" className="w-full sm:w-auto bg-bee-amber hover:bg-bee-orange text-bee-midnight font-bold h-14 px-10 rounded-full text-lg shadow-xl hover:-translate-y-1 transition-all duration-300">
                            Crie uma Conta – É Rápido
                        </Button>
                    </Link>
                    <Link href="/login" className="w-full sm:w-auto">
                        <Button variant="outline" size="lg" className="w-full sm:w-auto border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-bee-midnight font-bold h-14 px-10 rounded-full text-lg transition-all duration-300">
                            Já sou cliente
                        </Button>
                    </Link>
                </div>
