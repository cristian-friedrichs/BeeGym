    ...
    Tables: {
      ...
      saas_plans: {
        Row: {
          ...
          created_at: string | null
          description: string | null
          efi_plan_id_hml: number | null
          efi_plan_id_prd: number | null
          id: string
      ...
      saas_subscriptions: {
        Row: {
          ...
          status: string
          subscription_efi_id: number | null
          updated_at: string | null
          valor_mensal: number
        }
        Insert: {
      ...
      workout_execution: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_execution_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      workout_executions: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_executions_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
